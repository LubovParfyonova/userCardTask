...
/* const mapSocialIcons = new Map();

mapSocialIcons.set('www.facebook.com', 'assets/images/facebook.svg');
mapSocialIcons.set('www.instagram.com', 'assets/images/instagram.svg');
mapSocialIcons.set('twitter.com', 'assets/images/twitter.svg');
...
function createUserCard(user) {
    ...
    const lorem = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio quas repudiandae sed reiciendis modi reprehenderit rem, iste cupiditate'

    const p = createElement('p', {classNames: ['cardDescription']}, document.createTextNode(lorem));
